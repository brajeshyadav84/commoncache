namespace Common.Caching.SQLLite
{
    ...
    /// </summary>
    public class SQLLiteDatabaseProvider : ISQLLiteDatabaseProvider
    {
        /// <summary>
        ///     Connections pool
        /// </summary>
        ...
        ///     The options.
        /// </summary>
        private readonly SQLLiteDBOptions _options;
        ...
        public SQLLiteDatabaseProvider(string name , SQLLiteOptions options)
        {
            _name = name;
