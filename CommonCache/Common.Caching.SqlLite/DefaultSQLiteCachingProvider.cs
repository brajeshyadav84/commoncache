namespace Common.Caching.SQLLite
{
    ...
    /// </summary>
    public partial class SQLLiteCachingProvider : EasyCachingAbstractProvider
    {
        /// <summary>
        /// The cache.
        /// </summary>
        private ISQLLiteDatabaseProvider _dbProvider;

        /// <summary>
        /// The options.
        /// </summary>
        private readonly SQLLiteOptions _options;
        ...
        public SQLLiteCachingProvider(
            string name,
            IEnumerable<ISQLLiteDatabaseProvider> dbProviders,
            SQLLiteOptions options,
           ILoggerFactory loggerFactory = null)
        {
            this._dbProvider = dbProviders.Single(x => x.DBProviderName.Equals(name));
            this._options = options;
            this._logger = loggerFactory?.CreateLogger<SQLLiteCachingProvider>();
        ...
        private void InitDb(ISQLLiteDatabaseProvider dbProvider)
        {            
