namespace Common.Caching.Redis
{
    ...
    using Common.Caching.Core.Serialization;
    ...
    internal sealed class RedisOptionsExtension : IEasyCachingOptionsExtension
    {
        ...
        public void AddServices(IServiceCollection services)
        {
            ...
            Func<IServiceProvider, RedisCachingProvider> createFactory = x =>
            {
                ...
                return new RedisCachingProvider(_name, dbProviders, serializers, options, factory);
            };

            services.AddSingleton<IEasyCachingProvider, RedisCachingProvider>(createFactory);
            services.AddSingleton<IRedisCachingProvider, RedisCachingProvider>(createFactory);
        }
    }
}
